...
from src.main.app.schema.meta_table_schema import TableQuery, TableAdd, TableGenerate
from src.main.app.service.table_service import TableService


class MetaTableServiceImpl(BaseServiceImpl[TableMapper, MetaTableModel], TableService):
