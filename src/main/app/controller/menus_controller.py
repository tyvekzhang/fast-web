...
async def list_menus(
    ...
    list_menus_response: PageResult[Menu] = await menu_service.list_menus(
        req=req
    )
    return list_menus_response


# @menus_router.get("/menus/detail/{id}")
...
#
#
# @menus_router.get("/menus/export-template")
...
#
#
# @menus_router.post("/menus/batch-create")
...
#
#
# @menus_router.delete("/menus/remove/{id}")
...
#
#
# @menus_router.delete("/menus/batch-remove")
...
#
#
# @menus_router.put("/menus/batch-modify")
