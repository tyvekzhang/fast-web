...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "connection_database", sa.String(length=64), nullable=True, comment="连接数据库名称"
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "character_classification", sa.String(length=32), nullable=True, comment="字符分类"
        ),
    ...
    op.create_index(
        op.f("ix_db_databases_connection_id"), "db_databases", ["connection_id"], unique=False
    )
    op.create_table(
        "db_indexes",
        sa.Column("id", sa.BigInteger(), nullable=False, comment="主键"),
    ...
    op.create_index(
        op.f("ix_db_meta_fields_table_id"), "db_meta_fields", ["table_id"], unique=False
    )
    op.create_table(
        "db_meta_tables",
        sa.Column("id", sa.BigInteger(), nullable=False, comment="主键"),
    ...
    op.create_table(
        ...
        sa.Column(
            "sub_table_fk_name", sa.String(length=64), nullable=True, comment="子表关联的外键名"
        ),
        ...
        sa.Column(
            "gen_path", sa.String(length=255), nullable=True, comment="生成路径（不填默认项目路径）"
        ),
