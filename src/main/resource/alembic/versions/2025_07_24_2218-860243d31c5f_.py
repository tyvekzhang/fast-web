...
Revision ID: 860243d31c5f
Revises: 07b069d14db5
Create Date: 2025-07-24 22:18:57.010698
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column(
            "username", sa.String(length=32), nullable=True, comment="用户名"
        ),
        sa.Column(
            "password", sa.String(length=64), nullable=True, comment="密码"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column(
            "character_classification", sa.String(length=32), nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "name", sa.String(length=64), nullable=False, comment="字段名称"
        ),
        sa.Column(
            "type", sa.String(length=32), nullable=False, comment="字段类型"
        ),
        sa.Column("length", sa.Integer(), nullable=True, comment="总长度"),
        sa.Column("scale", sa.Integer(), nullable=True, comment="小数长度"),
        sa.Column(
            "default", sa.String(length=64), nullable=True, comment="默认值"
        ),
        sa.Column(
    ...
    op.create_index(
        op.f("ix_db_field_table_id"), "db_field", ["table_id"], unique=False
    )
    op.create_table(
        "db_index",
        sa.Column("id", sa.BigInteger(), nullable=False, comment="主键"),
        sa.Column("table_id", sa.BigInteger(), nullable=False, comment="表id"),
        sa.Column(
            "name", sa.String(length=64), nullable=False, comment="索引名称"
        ),
        sa.Column(
            "field", sa.String(length=64), nullable=False, comment="索引字段"
        ),
        sa.Column(
            "type", sa.String(length=16), nullable=False, comment="索引类型"
        ),
        sa.Column(
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), nullable=False, comment="主键"),
        sa.Column(
            "database_id", sa.BigInteger(), nullable=False, comment="数据库id"
        ),
        sa.Column(
            "name", sa.String(length=64), nullable=False, comment="表名称"
        ),
        sa.Column(
            "comment", sa.String(length=255), nullable=True, comment="备注"
        ),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.BigInteger(), nullable=False, comment="主键"),
        sa.Column(
            "db_table_id", sa.BigInteger(), nullable=False, comment="数据库表ID"
        ),
        sa.Column(
            "db_field_id",
            sa.BigInteger(),
        ...
        sa.Column(
            "js_type", sa.String(length=64), nullable=True, comment="JS类型"
        ),
        sa.Column("sort", sa.Integer(), nullable=True, comment="排序"),
        sa.Column(
            "default", sa.String(length=64), nullable=True, comment="默认值"
        ...
        sa.Column(
            "dict_type", sa.String(length=64), nullable=True, comment="字典类型"
        ),
        sa.Column(
            "comment", sa.String(length=255), nullable=True, comment="备注"
        ),
    ...
    op.create_index(
        op.f("ix_gen_field_db_field_id"),
        "gen_field",
        ["db_field_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_gen_field_db_table_id"),
        "gen_field",
        ["db_table_id"],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "table_name", sa.String(length=64), nullable=True, comment="表名"
        ),
        sa.Column(
            "sub_table_name",
            sa.String(length=64),
        ...
        sa.Column(
            "backend", sa.String(length=16), nullable=True, comment="后端语言"
        ),
        sa.Column(
            "tpl_category",
            sa.String(length=64),
        ...
        sa.Column(
            "comment", sa.String(length=64), nullable=True, comment="表描述"
        ),
        sa.Column(
            "create_time", sa.DateTime(), nullable=True, comment="创建时间"
        ),
    ...
    op.create_index(
        op.f("ix_gen_table_database_id"),
        "gen_table",
        ["database_id"],
        unique=False,
    )
    op.create_index(
        op.f("ix_gen_table_db_table_id"),
        "gen_table",
        ["db_table_id"],
        unique=False,
    )
